...
public class nikestepsMurad {
	...
	public void user_should_see_search_results_for(String searchTerm) {
		List<WebElement> titles = driver.findElements(By.xpath("//div[contains(@class, 'product-card product-grid__card')]//div[@class='product-card__titles']"));
       boolean found = false;
		for (WebElement title : titles) {
			...
			assertTrue(found, "searchTerm found");
		} 
	}
}
